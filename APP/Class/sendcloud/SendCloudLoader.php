...
function sendCloudLoader() {
	...
	/** SendCloud依赖 */
	require_once ROOT_DIR . '/SendCloud.php';
	require_once ROOT_DIR . '/SendCloud/Smtp.php';
	require_once ROOT_DIR . '/SendCloud/Message.php';
	require_once ROOT_DIR . '/SendCloud/AppFilter.php';
	require_once ROOT_DIR . '/SendCloud/SmtpApiHeader.php';
}
